...
يعمل في الخلفية للاستماع الدائم للرسائل الواردة من الأجهزة الأخرى على الشبكة.
"""
...
class ChatServer:
    ...
    def _listen_for_connections(self):
        ...
        while self.is_running:
            try:
                ...
                # يحدث بشكل طبيعي عند إغلاق السوكيت أثناء stop()
                break
    ...
    def _handle_client(self, client_socket, addr):
        """قراءة الرسالة كاملة من العميل، مهما كان حجمها، ثم تحليلها."""
        try:
            chunks = []
            while True:
